...
# ======================================================
#
# Here we demonstrate how to run PSyclone in code transformation mode from the command
# line. Despite being in 'transformation mode', we won't actually apply any code
# transformations in this demo. We'll simply read some Fortran source code and then
# write it out to a different file.
#
# .. warning::
#    The first, important thing to note is that these demos are not intended to be run
#    directly.
#
...
# different, even though the transformation function that we used was trivial. The
